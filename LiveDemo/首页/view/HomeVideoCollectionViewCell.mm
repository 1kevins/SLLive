...
//    _comment_countLabel.text = DataModel.comment_count;
    [self toSetUpThree_dimensionalShadows:_comment_countLabel andString:Model.signatures];
    
//    _titleLabel.text = DataModel.title;
    [self toSetUpThree_dimensionalShadows:_titleLabel andString:Model.signatures];
}
